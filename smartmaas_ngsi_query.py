...
class SmartMaasNGSIQuery(Plugin):
    ...
    def on_product_acquisition(self, asset, contract, order):
        ...
        keyrock_client.grant_permission(asset.meta_info['app_id'], order.customer, asset.meta_info['role'])
    ...
    def on_product_suspension(self, asset, contract, order):
        keyrock_client = KeyrockClient()
        keyrock_client.revoke_permission(asset.meta_info['app_id'], order.customer, asset.meta_info['role'])
